package com.rejowan.deviceinfo.fragments.apps
...
import com.rejowan.deviceinfo.adapter.AppsListAdapter
import com.rejowan.deviceinfo.databinding.FragmentSystemAppsBinding
...
class SystemAppsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        deviceDetailsViewModel.systemApps.observe(viewLifecycleOwner) {
            userApps.clear()
            userApps.addAll(it)
