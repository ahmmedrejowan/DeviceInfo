...
import com.androvine.deviceinfo.databinding.ActivityLightSensorBinding
...
class LightSensor : AppCompatActivity() {
    ...
    private val binding by lazy { ActivityLightSensorBinding.inflate(layoutInflater) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.yesButton.setOnClickListener {
            testingPrefs.setTestingPrefs(TestingPrefs.TestingPrefsKey.LIGHT_SENSOR.key, true)
            finish()
        }

        binding.noButton.setOnClickListener {
            testingPrefs.setTestingPrefs(TestingPrefs.TestingPrefsKey.LIGHT_SENSOR.key, false)
            finish()
        }
